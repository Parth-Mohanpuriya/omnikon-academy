...
import { mockUser, mockCourses, mockActivities } from "@/lib/mock-data";
...
export default function ProfilePageClient({ user: supabaseUser }: ProfilePageClientProps) {
  ...
  const [profileData, setProfileData] = useState<{
    ...
    return {
      name: supabaseUser?.user_metadata?.full_name || mockUser.name,
      email: supabaseUser?.email || mockUser.email,
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="relative h-24 w-24 rounded-xl border border-red-500/20 bg-zinc-900 overflow-hidden flex items-center justify-center flex-shrink-0">
                {avatarPreview ? (
                  ...
                  <img src={supabaseUser.user_metadata.avatar_url} alt="Avatar" className="h-full w-full object-cover" />
                ) : (
