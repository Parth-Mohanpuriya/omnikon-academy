            ...
            <div className="mt-12 p-6 rounded-xl border border-white/5 bg-[#070709]">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => {
                      const url = `https://omnikon.org/blog/${slug}`;
                      window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=${encodeURIComponent(post?.title || "")}`, "_blank", "noopener,noreferrer");
                    }}
                    className="p-2 rounded-lg border border-white/10 bg-[#0e0e11] hover:bg-white/5 transition-colors cursor-pointer"
                  >
