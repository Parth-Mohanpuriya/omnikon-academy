...
export default function DashboardPage() {
  ...
  // Helper to find the next lesson to resume
  const getNextLessonId = (course: Course) => {
    ...
    // Find first lesson ID that is NOT in progress.completedLessons
  ...
  // Calculate overall learning path progress (average of enrolled courses)
              ...
              <div className="rounded-xl border border-white/5 bg-[#060608] p-5 space-y-4 text-xs">
                ...
                <div className="space-y-3 text-[10px] leading-relaxed">
                  <div className="border-l-2 border-red-500/30 pl-2">
                    <p className="text-zinc-400">Welcome Alex Rivera. Git authentication verified.</p>
